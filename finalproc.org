...
** Languages in used virtual labs 
...
** Creation date of repositories in virtual labs
...
** topcommits
     Top five repositories of virtual labs in terms of commits
*** Implementation
#+NAME:topcommits
#+BEGIN_SRC python
...
#+END_SRC
** topdevelopers
     Top five repositories of virtual labs in terms of developers
*** Implementation
#+NAME: topdevelopers
#+BEGIN_SRC python
...
** topclosedissues
     Top five repositories of virtual labs in terms of closed issues
*** Implementation
...
* Views
** Closedissue
    Total number of closed issues in all repositories of virtual labs
*** Implementation
#+NAME: closedissue
...
** Top repositories with respect to commits.
*** implementation
#+NAME: groupcommit
...
#+END_SRC
** Total number of repositories in each year and total languages till date 
*** implementation
#+NAME: visualise
...
#+END_SRC
** Commits
      Graph for total number of commits in each repository.
*** implementation
#+NAME:commits
...
#+END_SRC
** Top repositories with respect to number of developers
*** implementation
#+NAME: groupdev
...
#+END_SRC
** Total number of issues in each repository
*** implementation
#+NAME: d3issues
...
#+END_SRC
** Total number of developers in each repository
*** implementation
#+NAME: developers
...
** Total number of repositories in each year.
*** implementation
#+NAME: d3repos
...
#+END_SRC
** Graph of top five repositories with respect to closed issues
*** implementation
...
#+END_SRC
** Graph for languages in virtual lab repositories.
*** implementation
#+NAME: d3visual
...
#+END_SRC
** Getdata
     Retrieving the data from the specific link (git API)
*** Implementation
#+NAME:getdata
#+BEGIN_SRC python
def getdata():
    ...
    return data
#+END_SRC
** Get the year when Repository was created
*** implementation
#+NAME:getyearofRepo
#+BEGIN_SRC python
...
#+END_SRC
** Make array
     Storing data in array (repeatedly used in other functions)
*** implementation
#+NAME:makearray
#+BEGIN_SRC python
...
def make2darray(dict):
    ...
    return repoData1
#+END_SRC
** Get data related to date when repository was created 
*** implementation
#+NAME: getrepohistory
#+BEGIN_SRC python
...
def getReposHistoryData():
    ...
    return repoData1
#+END_SRC
** Get data related to languages used in repositories 
*** Implementation
#+NAME:getrepolang
#+BEGIN_SRC python
...
#+END_SRC
** Getting data related to all languages used in repositories as JSON object
*** implementation
...
** Getting the data related to date when repository was created as JSON
*** Implementation
...
#+END_SRC
**  Getting data related to number of commits, developers and closed issues in each repository.
*** implementation
...
def getRepoCommitDevCIssueDataAsJSON():
    ...
    data = json.loads(response1.text)
    j=0
    token = '4c292af2b0ef1b59f5504c3462a33effc5cf6aef'
...
#+END_SRC
** Getting data related to number of open issues in each repository as JSON
*** implementation
